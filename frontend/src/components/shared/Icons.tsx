...
export function DirectMessageIcon(props: Props) {
    if (props.filled) {
        return <svg fill="#262626" height="22" viewBox="0 0 48 48" width="22">
            <path
        ...
        return <svg fill="#262626" height="24" viewBox="0 0 48 48" width="24">
            <path
